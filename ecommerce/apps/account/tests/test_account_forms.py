...
@pytest.mark.parametrize(
    "full_name, phone, address_line, address_line2, city, zipcode, validity",
    [
        ("mike", "123456789", "add1", "add2", "town", "zipcode", True),
        ("", "123456789", "add1", "add2", "town2", "zipcode", False),
    ],
)
...
def test_customer_create_address_302(client, customer):
    user = customer
    client.force_login(user)
